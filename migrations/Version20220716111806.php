...
final class Version20220716111806 extends AbstractMigration
{
    ...
    $this->addSql('CREATE TABLE contact (id INT AUTO_INCREMENT NOT NULL, country_id INT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, code_name VARCHAR(255) NOT NULL, birthday DATETIME NOT NULL, INDEX IDX_4C62E638F92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
